...
export const appAcceptance: readonly ToolcraftComponentAcceptance[] = [
  ...
  controlAcceptance({
    ...
    componentType: "slider",
    expectedObservable: "Dragging Contrast steepens the luminance-to-ink tone curve.",
    fixture: "source photo loaded",
    id: "source.contrast",
    target: "source.contrast",
    userAction: "Drag the Contrast slider with a source image loaded.",
  }),
  controlAcceptance({
  ...
  controlAcceptance({
    automatedTestName: "weight range ramps font weights",
    browserTestName: "browser: weight range ramps font weights",
    componentType: "slider",
    expectedObservable:
      "Dragging Weight range makes low-ink words render in lighter weights of the selected family.",
    fixture: "default word tide",
    id: "ink.weightRange",
    target: "ink.weightRange",
    userAction: "Drag the Weight range slider.",
  }),
  controlAcceptance({
  ...
  controlAcceptance({
    automatedTestName: "font picker styles every word",
    browserTestName: "browser: font picker styles every word",
    ...
    expectedObservable:
      "Changing font family, weight, size, letter spacing, line height, text case, color, and opacity restyles and relays out every placed word in preview and export.",
    fixture: "default word tide",
    id: "type.font",
    target: "type.font",
    userAction:
      "Pick a different family, weight, size, letter spacing, line height, case, color, and opacity.",
  }),
  controlAcceptance({
...
export const starterControlSectionInventory: readonly ToolcraftControlSectionInventoryEntry[] = [
  ...
  },
  {
    ...
    targets: ["source.invert", "ink.fade", "source.contrast", "ink.weightRange", "ink.sparsity"],
    title: "Ink Mapping",
  ...
  {
    entity: "Word grid",
    groupingReason: "Gap and jitter shape the dither-mode grid geometry.",
    targets: ["grid.gap", "grid.jitter"],
    title: "Word Grid",
  ...
  },
  {
    ...
    groupingReason: "One fontPicker owns family, weight, size, spacing, case, color, and opacity for every word.",
    targets: ["type.font"],
    title: "Typography",
