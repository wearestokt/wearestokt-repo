...
export const appProductReadiness: ToolcraftProductReadiness = {
  ...
  productSummary:
    "Unified vector-field streamline generator for ocean-current and wind-map style brand graphics with path attractors, tapered strokes, and color ramps.",
  requestedBehavior:
    "Create state-of-the-art flow graphics inspired by ocean currents and wind patterns using real streamline tracing, path bending, expressive stroke styling, and speed-mapped color ramps.",
};
...
export const appAcceptance: readonly ToolcraftComponentAcceptance[] = [
  ...
  controlAcceptance({
    ...
    expectedObservable: "Dragging Reach changes how far path influence extends in the field.",
    fixture: "flow field with path",
    id: "paths.reach",
    target: "paths.reach",
  ...
  controlAcceptance({
    ...
    componentType: "slider",
    expectedObservable: "Dragging Strength changes how strongly paths bend nearby streamlines.",
    fixture: "flow field with path",
    id: "paths.strength",
  ...
  controlAcceptance({
    ...
    componentType: "actions",
    expectedObservable: "Clicking Delete path removes the active path from the field.",
    fixture: "flow field with path",
    id: "paths.deletePath",
  ...
  controlAcceptance({
    automatedTestName: "field preset changes product output",
    browserTestName: "browser: field preset changes product output",
    componentType: "select",
    expectedObservable: "Choosing a field preset retunes procedural motion and stream density.",
    fixture: "default flow field",
    id: "flow.texturePreset",
    optionCoverage: "each-visible-item",
    target: "flow.texturePreset",
    userAction: "Open the Preset select and choose Storm.",
  }),
  controlAcceptance({
    automatedTestName: "flow pattern changes product output",
    browserTestName: "browser: flow pattern changes product output",
    componentType: "select",
    expectedObservable: "Choosing a different flow pattern changes streamline geometry.",
    fixture: "default flow field",
    id: "flow.pattern",
    optionCoverage: "each-visible-item",
    target: "flow.pattern",
  ...
  controlAcceptance({
    ...
    componentType: "slider",
    expectedObservable: "Dragging Direction rotates the vector field.",
    fixture: "default flow field",
    id: "flow.direction",
  ...
  controlAcceptance({
    ...
    componentType: "slider",
    expectedObservable: "Dragging Scale rescales procedural feature size in the field.",
    fixture: "default flow field",
    id: "flow.frequency",
  ...
  controlAcceptance({
    ...
    componentType: "slider",
    expectedObservable: "Dragging Turbulence distorts the field with curl noise.",
    fixture: "default flow field",
    id: "flow.turbulence",
  ...
  controlAcceptance({
    automatedTestName: "flow seed changes product output",
    browserTestName: "browser: flow seed changes product output",
    componentType: "slider",
    expectedObservable: "Changing Seed explores a different procedural field variation.",
    fixture: "default flow field",
    id: "flow.seed",
    target: "flow.seed",
  ...
  controlAcceptance({
    ...
    automatedTestName: "randomize seed changes product output",
    browserTestName: "browser: randomize seed changes product output",
    componentType: "actions",
    expectedObservable: "Clicking Randomize advances the field seed and changes stream layout.",
    fixture: "default flow field",
    id: "flow.randomizeSeed",
    target: "flow.randomizeSeed",
    userAction: "Click Randomize.",
  }),
  controlAcceptance({
    automatedTestName: "flow snap angles changes product output",
    browserTestName: "browser: flow snap angles changes product output",
    componentType: "select",
    expectedObservable: "Choosing snap angles quantizes field direction for sharper compositions.",
    fixture: "default flow field",
    id: "flow.snapAngles",
    optionCoverage: "each-visible-item",
    target: "flow.snapAngles",
    userAction: "Open Snap angles and choose 90°.",
  }),
  controlAcceptance({
    actionCoverage: ["shuffle"],
    automatedTestName: "shuffle changes product output",
    browserTestName: "browser: shuffle changes product output",
    componentType: "actions",
    expectedObservable: "Clicking Shuffle randomizes seed, palette, pattern, variety, and spacing.",
    fixture: "default flow field",
    id: "flow.shuffle",
    target: "flow.shuffle",
    userAction: "Click Shuffle.",
  }),
  controlAcceptance({
    automatedTestName: "streams density changes product output",
    browserTestName: "browser: streams density changes product output",
    componentType: "slider",
    expectedObservable: "Dragging Density changes how many streamlines fill the canvas.",
    fixture: "default flow field",
    id: "streams.density",
  ...
  controlAcceptance({
    automatedTestName: "streams spacing mode changes product output",
    browserTestName: "browser: streams spacing mode changes product output",
    componentType: "select",
    expectedObservable: "Packed mode uses stroke width for collision spacing; Loose allows overlap.",
    fixture: "default flow field",
    id: "streams.spacingMode",
    optionCoverage: "each-visible-item",
    target: "streams.spacingMode",
    userAction: "Open Spacing mode and choose Packed.",
  }),
  controlAcceptance({
    automatedTestName: "color opacity changes product output",
    browserTestName: "browser: color opacity changes product output",
    componentType: "slider",
    expectedObservable: "Dragging Stream opacity changes stroke transparency.",
    fixture: "default flow field",
    id: "color.opacity",
    target: "color.opacity",
    userAction: "Drag Stream opacity.",
  }),
  controlAcceptance({
    automatedTestName: "streams gap visibility changes with spacing mode",
    browserTestName: "browser: streams gap visibility changes with spacing mode",
    componentType: "slider",
    expectedObservable: "Gap is visible when Spacing mode is Packed and hidden otherwise.",
    fixture: "default flow field packed spacing",
    id: "streams.gap",
    target: "streams.gap",
    userAction: "Set Spacing mode to Packed, then drag Gap.",
  }),
  controlAcceptance({
    automatedTestName: "custom palette section visibility changes with palette",
    browserTestName: "browser: custom palette section visibility changes with palette",
    componentType: "color",
    expectedObservable: "Custom palette slots appear when Palette is Custom and hide for presets.",
    fixture: "default flow field custom palette",
    id: "color.custom1",
    target: "color.custom1",
    userAction: "Set Palette to Custom, then edit the first custom slot.",
  }),
  controlAcceptance({
    automatedTestName: "color custom2 changes product output",
    browserTestName: "browser: color custom2 changes product output",
    componentType: "color",
    expectedObservable: "When Palette is Custom, slot 2 is visible and hidden for presets; editing it changes palette sampling.",
    fixture: "default flow field custom palette",
    id: "color.custom2",
    target: "color.custom2",
    userAction: "Set Palette to Custom, then edit the second custom slot.",
  }),
  controlAcceptance({
    automatedTestName: "color custom3 changes product output",
    browserTestName: "browser: color custom3 changes product output",
    componentType: "color",
    expectedObservable: "When Palette is Custom, slot 3 is visible and hidden for presets; editing it changes palette sampling.",
    fixture: "default flow field custom palette",
    id: "color.custom3",
    target: "color.custom3",
    userAction: "Set Palette to Custom, then edit the third custom slot.",
  }),
  controlAcceptance({
    automatedTestName: "color custom4 changes product output",
    browserTestName: "browser: color custom4 changes product output",
    componentType: "color",
    expectedObservable: "When Palette is Custom, slot 4 is visible and hidden for presets; editing it changes palette sampling.",
    fixture: "default flow field custom palette",
    id: "color.custom4",
    target: "color.custom4",
    userAction: "Set Palette to Custom, then edit the fourth custom slot.",
  }),
  controlAcceptance({
    automatedTestName: "color custom5 changes product output",
    browserTestName: "browser: color custom5 changes product output",
    componentType: "color",
    expectedObservable: "When Palette is Custom, slot 5 is visible and hidden for presets; editing it changes palette sampling.",
    fixture: "default flow field custom palette",
    id: "color.custom5",
    target: "color.custom5",
    userAction: "Set Palette to Custom, then edit the fifth custom slot.",
  }),
  controlAcceptance({
    automatedTestName: "streams margin changes product output",
    browserTestName: "browser: streams margin changes product output",
    componentType: "slider",
    expectedObservable: "Dragging Margin insets streamline seeds from canvas edges.",
    fixture: "default flow field",
    id: "streams.margin",
    target: "streams.margin",
    userAction: "Drag the Margin slider.",
  }),
  controlAcceptance({
    automatedTestName: "streams length min changes product output",
    browserTestName: "browser: streams length min changes product output",
    componentType: "slider",
    expectedObservable: "Dragging Length min shortens streamlines in slow or tight regions.",
    fixture: "default flow field",
    id: "streams.lengthMin",
    target: "streams.lengthMin",
    userAction: "Drag the Length min slider.",
  }),
  controlAcceptance({
    automatedTestName: "streams length max changes product output",
    browserTestName: "browser: streams length max changes product output",
    componentType: "slider",
    expectedObservable: "Dragging Length max lengthens streamlines in fast straight regions.",
    fixture: "default flow field",
    id: "streams.lengthMax",
    target: "streams.lengthMax",
    userAction: "Drag the Length max slider.",
  }),
  controlAcceptance({
    automatedTestName: "streams length contrast changes product output",
    browserTestName: "browser: streams length contrast changes product output",
    componentType: "slider",
    expectedObservable: "Dragging Length contrast increases short-vs-long streamline variation.",
    fixture: "default flow field",
    id: "streams.lengthContrast",
    target: "streams.lengthContrast",
    userAction: "Drag the Length contrast slider.",
  }),
  controlAcceptance({
    automatedTestName: "streams smoothness changes product output",
    browserTestName: "browser: streams smoothness changes product output",
    componentType: "slider",
    expectedObservable: "Dragging Smoothness refines streamline curvature and integration steps.",
    fixture: "default flow field",
    id: "streams.smoothness",
    target: "streams.smoothness",
    userAction: "Drag the Smoothness slider.",
  }),
  controlAcceptance({
    automatedTestName: "stroke style changes product output",
    browserTestName: "browser: stroke style changes product output",
    componentType: "select",
    expectedObservable: "Choosing line, arrow, dash, rectangle, or hatch changes streamline rendering style.",
    fixture: "default flow field",
    id: "stroke.style",
    optionCoverage: "each-visible-item",
    target: "stroke.style",
    userAction: "Open the Style select and choose Dash.",
  }),
  controlAcceptance({
    automatedTestName: "stroke width changes product output",
    browserTestName: "browser: stroke width changes product output",
    componentType: "slider",
    expectedObservable: "Dragging Width changes base streamline thickness.",
    fixture: "default flow field",
    id: "stroke.width",
    target: "stroke.width",
  ...
  controlAcceptance({
    automatedTestName: "stroke width by speed changes product output",
    browserTestName: "browser: stroke width by speed changes product output",
    componentType: "slider",
    expectedObservable: "Dragging Width by speed thickens faster streamlines.",
    fixture: "default flow field",
    id: "stroke.widthBySpeed",
    target: "stroke.widthBySpeed",
    userAction: "Drag the Width by speed slider.",
  }),
  controlAcceptance({
    automatedTestName: "stroke size variety changes product output",
    browserTestName: "browser: stroke size variety changes product output",
    componentType: "slider",
    expectedObservable: "Dragging Size variety samples thin, base, thick, and XL stroke classes.",
    fixture: "default flow field",
    id: "stroke.sizeVariety",
    target: "stroke.sizeVariety",
    userAction: "Drag the Size variety slider.",
  }),
  controlAcceptance({
    automatedTestName: "stroke taper changes product output",
    browserTestName: "browser: stroke taper changes product output",
    componentType: "select",
    expectedObservable: "Choosing a taper mode changes streamline width along each stroke.",
    fixture: "default flow field",
    id: "stroke.taper",
    optionCoverage: "each-visible-item",
    target: "stroke.taper",
    userAction: "Open the Taper select and choose Both.",
  }),
  controlAcceptance({
    automatedTestName: "stroke head size changes product output",
    browserTestName: "browser: stroke head size changes product output",
    componentType: "slider",
    expectedObservable: "When Style is Arrow, Arrow head is visible and scales arrowheads; other styles hide Arrow head.",
    fixture: "default flow field arrow style",
    id: "stroke.headSize",
    target: "stroke.headSize",
    userAction: "Set Style to Arrow, then drag Arrow head.",
  }),
  controlAcceptance({
    automatedTestName: "color palette changes product output",
    browserTestName: "browser: color palette changes product output",
    componentType: "select",
    expectedObservable: "Choosing a palette changes stroke colors and pairs the background.",
    fixture: "default flow field",
    id: "color.palette",
    optionCoverage: "each-visible-item",
    target: "color.palette",
    userAction: "Open Palette and choose Ember.",
  }),
  controlAcceptance({
    automatedTestName: "color assignment mode changes product output",
    browserTestName: "browser: color assignment mode changes product output",
    componentType: "select",
    expectedObservable: "Assignment mode changes how palette colors map to strokes.",
    fixture: "default flow field",
    id: "color.assignmentMode",
    optionCoverage: "each-visible-item",
    target: "color.assignmentMode",
    userAction: "Open Assignment and choose Vertical gradient.",
  }),
  controlAcceptance({
    automatedTestName: "color opacity changes product output",
    browserTestName: "browser: color opacity changes product output",
  ...
  controlAcceptance({
    ...
    componentType: "switch",
    expectedObservable:
      "Disabling Include makes PNG export transparent (alpha), hides the live preview product background while the canvas shell stays visible, and video output would still keep the product background.",
    fixture: "default flow field",
  ...
  controlAcceptance({
    ...
    componentType: "select",
    evidence: "exported-bytes",
    expectedObservable: "Choosing 2K/4K/8K changes the exported PNG long-edge pixel dimensions.",
    fixture: "default flow field",
...
export const starterControlSectionInventory: readonly ToolcraftControlSectionInventoryEntry[] = [
  {
    entity: "Flow paths",
    groupingReason: "Path edit mode, reach, strength, and path actions shape field attractors.",
    targets: [
      "paths.editMode",
      "paths.reach",
      "paths.strength",
  ...
  },
  {
    ...
    groupingReason:
      "Preset, pattern, direction, scale, swirl, turbulence, and seed define the base field.",
    targets: [
      "flow.texturePreset",
      "flow.pattern",
      "flow.direction",
  ...
  {
    entity: "Streamline tracing",
    groupingReason: "Density, length range, contrast, and smoothness control traced stream output.",
    targets: [
      "streams.density",
      "streams.spacingMode",
      "streams.gap",
    ...
    title: "Streams",
    workflowStage: "Trace the streams",
  },
  {
    entity: "Stroke styling",
    groupingReason: "Style, width, speed width, taper, and head size shape streamline rendering.",
    targets: [
      "stroke.style",
      "stroke.width",
      "stroke.widthBySpeed",
    ...
    title: "Stroke",
    workflowStage: "Style the strokes",
  },
  {
    entity: "Stream palette",
    groupingReason: "Palette preset, assignment mode, opacity, and custom slots form one probabilistic color system.",
    targets: [
      "color.palette",
    ...
    title: "Palette",
    workflowStage: "Color the streams",
  },
  {
...
export function validateToolcraftAcceptanceCoverage(
  ...
  if (schemaHasPngExportPanelAction(schema)) {
    ...
    if (!imageFormatControl) {
      ...
      if (imageFormatControl.defaultValue !== "svg") {
        errors.push('Image Export format must default to "svg".');
      }
    }
    ...
    if (!imageResolutionControl) {
      ...
      if (imageResolutionControl.defaultValue !== "2k") {
        errors.push('Image Export resolution must default to "2k".');
      }
    }
